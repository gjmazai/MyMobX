...
export class ObservableObject {
  constructor( target ) {
    ...
    /**
     * создаем объект значений, это копия объекта, приходящего извне, 
     * только все значения обернуты в ObservableValue.
     */
    this._values = Object.fromEntries( Object
                                      .entries( target )
                                      .map(([ key, value ]) => 
  ...
  /**
  * Метод, который возвращает значение из ObservableValue.
 ...
 /**
  * Метод, который устанавливает значения для ObservableValue и для внешнего объекта.
  * @param target - наблюдаемый объект.
  * @param property - свойство этого объекта.
  ...
  */
  ...
  /**
   * Метод проверяет содержиться ли свойство в наблюдаемом объекте. 
